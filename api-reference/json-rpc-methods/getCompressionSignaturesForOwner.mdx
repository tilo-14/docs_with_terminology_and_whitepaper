...
description: "Returns the signatures of the transactions that have modified an owner's compressed accounts. This is a paginated endpoint"
...
<ParamField body="params" type="object" required>
  Request parameters for compression signatures by owner
</ParamField>
